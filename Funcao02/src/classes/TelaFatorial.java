...
public class TelaFatorial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblFormula.setFont(new java.awt.Font("Noto Sans", 1, 14)); // NOI18N
        lblFormula.setText("Formula");

        lblResultado.setFont(new java.awt.Font("Noto Sans", 1, 14)); // NOI18N
        lblResultado.setText("Resultado");

        btnFatorial.setFont(new java.awt.Font("Noto Sans", 1, 18)); // NOI18N
        btnFatorial.setText("!");
    ...
    private void btnFatorialActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFatorialActionPerformed
        ...
        // é possivel criar um objeto instanciado da classe, ou chamar diretamente a classe!
        // abaixo os dois exemplos
        // a IDE sugere que se chame a classe, nao a instancia
        Fatorial f = new Fatorial(); //instancia o objeto f da classe FATORIAL
        Fatorial.setValor(n); //chama diretamente a classe
        lblFormula.setText(f.getFormula()); //ja é string - chama a instancia
        lblResultado.setText(String.format("%.0f" , Fatorial.getFatorial())); //converte float para string - chama a classe
