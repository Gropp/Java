...
public class ResolucaoSwing extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/resimage.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("DejaVu Sans", 1, 14)); // NOI18N
        jLabel2.setText("A Resolução do seu monitor está em:");

        lblResolucao.setText("processando...");

        btnResolucao.setFont(new java.awt.Font("Monospaced", 1, 13)); // NOI18N
        btnResolucao.setForeground(new java.awt.Color(238, 21, 21));
    ...
    private void btnResolucaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResolucaoActionPerformed
        ...
        /* Dimension é um inteiro, que nao pode ser covertido com toString */
        lblResolucao.setText(String.valueOf(d.width)+" x "+String.valueOf(d.height));
